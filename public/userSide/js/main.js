...
$(document).ready(function () {
  ...
  $(".active-banner-slider").owlCarousel({
    ...
    loop: true,
    nav: true,
    navText: ["<img src='userSide/img/banner/prev.png'>", "<img src='userSide/img/banner/next.png'>"],
    dots: false
  });
  ...
  $(".active-product-area").owlCarousel({
    ...
    loop: true,
    nav: true,
    navText: ["<img src='userSide/img/product/prev.png'>", "<img src='userSide/img/product/next.png'>"],
    dots: false
  });
