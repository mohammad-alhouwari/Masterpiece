                        ...
                        <form class="row login_form" action="{{ route('login') }}" method="post" id="contactForm"
                            ...
                            <div class="mt-4 col-md-12 form-group">
                                ...
                                <x-text-input id="password" class="block mt-1 w-full form-control" type="password"
                                    name="password" placeholder="الرقم السري" required autocomplete="current-password" />
                            ...
                            <div class="flex items-center justify-end mt-4 mx-auto">
                                ...
                                <x-primary-button class="ml-3 primary-btn mb-1">
                                    {{ __('تسجيل الدخول') }}
                                </x-primary-button>
                                {{-- <a href="{{ route('googlelogin') }}">
                                    <img src="{{ asset('assets/img/googlelogin.png') }}"
                                        style="height: 80px;width: 70%; margin-left: 60px; margin-top: 8px;" alt="photo55">
                                </a> --}}

                                @if (Route::has('password.request'))
                                    <a class="underline d-block main-text text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
