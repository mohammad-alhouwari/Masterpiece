    ...
    <script src="{{ asset('dash/js/plugins/fullcalendar.min.js') }}"></script>
    ...
    <script src="{{ asset('dash/js/plugins/choices.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('dash/js/soft-ui-dashboard.min.js?v=1.0.3') }}"></script>
    ...
    <script src="{{ asset('dash/js/validation-custom.js') }}"></script>
    <script src="{{ asset('dash/js/sweetalert-custom.js') }}"></script>
    <script src="{{ asset('dash/js/imageCropper.js') }}"></script>
    </body>
