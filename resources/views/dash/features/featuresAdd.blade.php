                    ...
                    <div class="container py-4">
                        <div class="row">
                            <div class="col-lg-8 mx-auto d-flex justify-content-center flex-column">
                                <h3 class="text-center text-primary text-shadow">إضافة ميزة جديدة للموقع</h3>
                                <form role="form" action="{{ route('dashboard.general.features.featureStore') }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control px-5" placeholder="" id="name"
                                                    aria-label="العنوان..." type="text" name="name" required>
                                            </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control px-5" id="description" rows="2" name="description" required></textarea>
